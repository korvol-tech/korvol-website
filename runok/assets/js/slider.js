  ...
  $(document).ready(function () {
    function sliderAnimations(elements) {
      ...
      elements.each(function () {
        ...
        var $animationType =
          "angularSlant-animation " + $this.data("animation");
        $this.css({
    ...
    var sliderOptions = {
      ...
      pagination: {
        el: ".angularSlant-swiper-pagination",
        clickable: true,
      },
    };
    sliderOptions.on = {
    ...
    var swiper = new Swiper(".angularSlant-slider-2", sliderOptions);
    ...
    var swiper2 = new Swiper(".angularSlant-slider", slider2Options);
  });
})(jQuery);
