      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <div className="container">
              <div className="page-header-content text-center">
                ...
                <h4 className="sub-title">
                  ...
                  <span></span>
                  <a className="inner-page" href="about.html">
                    {" "}
                    About Us
                  </a>
                </h4>
                  ...
                  <div className="about-img-box">
                    <div className="shapes">
                      <img
                        ...
                        src="assets/img/shapes/about-shape-1.png"
                        alt="about"
                      />
                      <img
                        className="shape shape-2"
                        src="assets/img/shapes/about-shape-2.png"
                        alt="about"
                      />
                    </div>
                    <div className="img-1 reveal">
                      <img
                        src="assets/img/images/about-img-2.jpg"
                        alt="about"
                      />
                    </div>
                    <div className="img-2 reveal">
                      <img
                        src="assets/img/images/about-img-3.jpg"
                        alt="about"
                      />
                    </div>
                  </div>
                ...
                <div className="col-lg-7 col-md-12">
                  <div className="about-content-2">
                    <div className="section-heading">
                      ...
                      <p>
                        Platea vehicula rutrum curae magna taciti acut malesuada
                        inceptos phasellus massa, eget ultrices tempor lacinia
                        dictumst tincidunt leo mollis luctus varius gravida
                        eleifend cursus litora consequat...
                      </p>
                    </div>
              ...
              <div className="row gy-lg-0 gy-4">
                <div className="col-lg-4 col-md-6">
                  <div className="process-box fade-top">
                    ...
                    <p>
                      Autem vel eum repreh enderit eui in ea velit esse quame
                      nihil molestiae
                    </p>
                    <a href="about.html" className="read-more">
                      Read More
                      <i className="fa-sharp fa-regular fa-chevrons-right"></i>
                    </a>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6">
          ...
          <div className="running-text running-3">
            <div
              className="bg-img"
              data-background="assets/img/bg-img/running-bg.jpg"
            ></div>
            <div
              className="carouselTicker carouselTicker-nav"
              data-speed="fast"
            >
                    ...
                    <div className="about-tab">
                      ...
                      <div className="tab-content" id="nav-tabContent">
                        ...
                        >
                          ...
                          <p className="mb-20">
                            A web design agency is a multifaceted entity that
                            plays a pivotal role in shaping the digital presence
                            of businesses and individuals alike. These agencies
                            are dynamic hubs of creativity, technical expertise,
                            and strategic thinking.
                          </p>
                          <p className="mb-0">
                            At the core of a web design agency&apos;s essence
                            lies the artistry of visual storytelling and user
                            experience creation.
                          </p>
                        </div>
                        <div
                ...
                <div className="col-lg-6">
                  <div className="about-img-wrap-5">
                    <div className="shapes">
                      <div className="shape shape-1">
                        <img
                          src="assets/img/shapes/about-shape-4.png"
                          alt="shape"
                        />
                      </div>
                      <div className="shape shape-2">
                        <img
                          src="assets/img/shapes/about-shape-5.png"
                          alt="shape"
                        />
                      </div>
                    </div>
                    <div className="about-img reveal">
                      <img
                        className="img-1"
                        src="assets/img/images/about-img-8.png"
                        alt="img"
                      />
                    </div>
                    <div className="about-img-2 reveal">
                      <img
                        className="img-2"
                        src="assets/img/images/about-img-9.png"
                        alt="img"
                      />
                    </div>
                  </div>
              ...
              <div className="row gy-lg-0 gy-5">
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="team-item fade-top">
                    ...
                    <div className="team-content">
                      <h3 className="title">
                        <a href="team-details.html">Maiselan Willam</a>
                      </h3>
              ...
              <div className="row gy-lg-0 gy-4 testi-wrap justify-content-center">
                <div className="col-lg-4 col-md-6">
                  <div className="testi-item item-3 text-center fade-top">
                    ...
                    <div className="testi-content">
                      <h3 className="author">
                        Daniel Joseph <span>Writter</span>
                      </h3>
                      <p>
                        Curabitur accumsan nec aliquam mauris placat primis
                        lacinia egestas congue facilisis ligula leo sociosqu
                        consequat
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="testi-item item-3 text-center fade-top">
                    ...
                    <div className="testi-content">
                      <h3 className="author">
                        Victoria Madison <span>Writter</span>
                      </h3>
                      <p>
                        Curabitur accumsan nec aliquam mauris placat primis
                        lacinia egestas congue facilisis ligula leo sociosqu
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="testi-item item-3 mb-0 text-center fade-top">
                    ...
                    <div className="testi-content">
                      <h3 className="author">
                        Nicholas Thomas <span>Writter</span>
                      </h3>
                      <p>
                        Curabitur accumsan nec aliquam mauris placat primis
                        lacinia egestas congue facilisis ligula leo sociosqu
